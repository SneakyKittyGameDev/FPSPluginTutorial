...
public:
	...
	static void SpawnProjectileImpactEffects(const AActor* WorldActor, const FHitResult& HitResult, const FDecalImpactSettings& DecalImpactSettings, const FSoundImpactSettings& SoundImpactSettings);
	UFUNCTION(BlueprintCallable, Category = "FPSTemplate | Character")
	static void SpawnFootstepImpactEffects(const AActor* WorldActor, const FHitResult& HitResult, const FDecalImpactSettings& DecalImpactSettings, const FSoundImpactSettings& SoundImpactSettings);

	UFUNCTION(BlueprintCallable, Category = "FPSTemplate | Effects")
	static void SpawnImpactEffect(const AActor* WorldActor, const FHitResult& HitResult, const FImpactEffects& ImpactEffect);
	UFUNCTION(BlueprintCallable, Category = "FPSTemplate | Effects")
	static void SpawnEmptyCaseSound(const AActor* WorldActor, const FHitResult& HitResult);
	static void SpawnEffects(const AActor* WorldActor, const FHitResult& HitResult, const FImpactEffects& ImpactEffects);
